     ...
     <Div className="row align-items-center">
       ...
       <Div className="col-lg-6 order-lg-1 order-2">
         ...
         <Div className="cs-section_heading cs-style1">
           ...
           <Div className="cs-height_45 cs-height_lg_25" />
           <ul>
                <li>Beyond financial support: Mentorship program offers personalized guidance.</li>
                <li>Leverage wealth of experience for tailored mentorship.</li>
                <li> Your trusted partner to guide you through financial decisions.</li>
          </ul>
     ...
     <Div className="row align-items-center">
       ...
       <Div className="col-lg-6">
         ...
         <Div className="cs-section_heading cs-style1">
           ...
           <ul>
                <li>Strategic Roll-ups drive business efficiency and market positioning.</li>
                <li>Navigate complexities with Rits Capital's expert integration guidance..</li>
                <li> Propel business to new heights with seamless consolidation.</li>
          </ul>
     ...
     <Div className="row align-items-center">
       ...
       <Div className="col-lg-6 order-lg-1 order-2">
         ...
         <Div className="cs-section_heading cs-style1">
           ...
           <Div className="cs-height_45 cs-height_lg_25" />
           <ul>
                <li>	Rits Capital offers premium, strategically located Office Spaces.</li>
                <li>Elevate operations in a professional environment fostering productivity.</li>
                <li> Gain access to facilities for seamless operation.</li>
          </ul>
     ...
     <Div className="row align-items-center">
       ...
       <Div className="col-lg-6">
         ...
         <Div className="cs-section_heading cs-style1">
           ...
           <Div className="cs-height_45 cs-height_lg_25" />
           <ul>
                <li>	Embark on your financial journey with confidence, supported by Rits Capital.</li>
                <li>Financial experts assist in securing capital for startups.</li>
                <li> Benefit from extensive network to propel business forward.</li>
          </ul>
