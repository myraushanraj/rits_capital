...
const Wealthmanagement = () => {
  return (
   ...
   <Div className="container">
     <Div className="row align-items-center">
       <Div className="col-xl-6 col-lg-6 ">
         ...
         <Div className="cs-radius_15 cs-shine_hover_1 position-relative">
         <img src="/images/bgcircle.jpg" alt=""  style={{  width: '80%', height: '80%', zIndex: -1 }}/>
         <img src="/images/h11.jpg" alt="Member" className='imagetop'  />
         </Div>
     ...
     <Div className="row align-items-center">
       ...
       <Div className="col-xl-6 col-lg-6 ">
         <Div className="cs-radius_15 cs-shine_hover_1">
           <img src="/images/h12.jpg" alt="Member" className="w-100" />
         </Div>
       </Div>
     </Div>
   ...
   <Div className="container">
     <Div className="row align-items-center">
       <Div className="col-xl-6 col-lg-6">
         <Div className="cs-radius_15 cs-shine_hover_1">
           <img src="/images/webicons/trader.png" alt="Member" className="" />
         </Div>
       </Div>
       <Div className="col-lg-6">
         <Spacing lg='0' md='45'/>
 ...
 <br /> Here’s how we stand out:
Exceptional Investment Returns
Our Approach to Start-Up Investments
...
Strong Growth Potential
 ...
 <Div className="cs-height_10 cs-height_lg_10" />
           ...
           {/* <Div className="cs-height_25 cs-height_lg_20" /> */}
           <p className="cs-m0">Here’s what sets us apart in the realm of real estate investment:<br /> Unmatched Expertise in Data-Driven Investments
Strategic Market Research
Focus on Value
Prime Locations and High-Quality Construction
Attractive Rental Yields
</p>
           <Div className="cs-height_25 cs-height_lg_20" />

<p>Investing in real estate offers a unique blend of safety, growth, and income. Our data-driven approach, combined with deep market insights and a focus on quality, positions us to capitalize on the most lucrative real estate opportunities. Whether you’re looking to diversify your investment portfolio or seeking stable income through rental yields, our Real Estate Investment division is equipped to exceed your expectations.</p>
           <Div className="cs-height_45 cs-height_lg_30" />
           {/* <SocialWidget/> */}
         </Div>
       </Div>
       <Div className="col-xl-6 col-lg-6">
         <Div className="cs-radius_15 cs-shine_hover_1">
           <img src="/images/webicons/investor.png" alt="Member" className="w-100" style={{  width: '80%', height: '80%', zIndex: -1 }} />
         </Div>
       </Div>
     </Div>
   ...
   <Div className="container">
     <Div className="row align-items-center">
       <Div className="col-xl-6 col-lg-6">
         <Div className="cs-radius_15 cs-shine_hover_1">
           <img src="/images/webicons/Wealth-300.gif" alt="Member" className="w-100" />
         </Div>
       </Div>
       <Div className="col-lg-6">
         <Spacing lg='0' md='45'/>
...
<br /> <br />
Here’s how we stand out in the SME IPO investment landscape: <br /><br />

Targeting Promising SMEs with Strong Fundamentals <br />

Identifying Growth Stories: <br />
Deep Industry Expertise: <br />
Rigorous Due Diligence Process <br />
<br /> 
...
With Rits Capital, you gain access to:
<br />
A curated selection of SMEs with high growth potential and strong fundamentals.
Expert insights and thorough due diligence, reducing investment risks and enhancing potential returns.
A diversified investment portfolio across various industries, mitigating sector-specific risks and capitalizing on broader market opportunities.
